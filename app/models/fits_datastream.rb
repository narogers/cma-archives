# Replace status_message with filestatus_message until the migration to
# Sufia 7 happens to avoid errors with ActiveRecord since it now protects
# that attribute
class FitsDatastream < ActiveFedora::OmDatastream
  ...
  set_terminology do |t|
    ...
    t.filestatus do
      ...
      t.valid(path: "valid")
      t.filestatus_message(path: "message")
    end
    t.metadata do
      t.document do
    ...
    t.filestatus_message(proxy: [:filestatus, :filestatus_message])
