# Overide status_message to address a bug with overlapping properties.
# Will be fixed once a migration to PCDM takes place
module Sufia
  module GenericFile
    module Characterization
      ...
      included do
        ...
        property :filestatus_message,    delegate_to: 'characterization'
